...
> java -classpath ./build/libs/nucleus-taxonomy-0.1-snapshot-fat.jar: -Dvertx.logger-delegate-factory-class-name=io.vertx.core.logging.SLF4JLogDelegateFactory io.vertx.core.Launcher -conf src/main/taxonomys/nucleus-taxonomy.json -cluster -instances 4
